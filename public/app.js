...
function brand() {
  return `<header class="topbar"><div class="brand"><img class="brand-logo" src="/brand/logo-512.png?v=20260915-logo2" alt="" width="36" height="36"><span>向野<small>INTO THE WILD</small></span></div>${trip ? "" : '<span class="eyebrow">轻装出发</span>'}</header>`;
}
function render() {
